...
if User.find_by_email("admin@.com").nil?
	User.create(age: 12, name: 'Julian', gender: 'M', email: 'admin@unal.edu.co', password:'administrator', picture:"http://bdfjade.com/data/out/142/6448580-profile-pictures.jpg")
